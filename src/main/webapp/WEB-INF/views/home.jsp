			...
			<div class="row">
				...
				<div class="col-2">
					<button class="btn btn-sm btn-primary"
						onclick="location.href='addsongpage'">Add Songs</button>
				</div>
			</div>
				...
				<div class="modal-body">
					<div class="container">
						...
						<div class="row mb-4">
							...
							<div class="col">
								<span id="star1" class="fa fa-star "></span> <span id="star2"
									class="fa fa-star "></span> <span id="star3"
									class="fa fa-star "></span> <span id="star4" class="fa fa-star"></span>
						...
						<div class="row mb-4">
							...
							<div class="col">
								<textarea rows="4" cols="22.5" placeholder="write a review"
